...
export default function SeoModule() {
  ...
  return (
    <div className="p-6 lg:p-8">
      ...
      <SectionCard title={t("seoContent.modulesTitle")} className="mb-6">
        <Link
          to="/seo/threads-commerce"
          className="inline-flex items-center gap-2 rounded-lg border border-border bg-card p-4 hover:bg-muted/50 transition-colors"
        >
          <ImageIcon className="w-5 h-5 text-primary" />
          <div className="text-left">
            <div className="font-medium text-foreground">{t("seoContent.threadsCommerceModuleTitle")}</div>
            <div className="text-xs text-muted-foreground">{t("seoContent.threadsCommerceModuleDesc")}</div>
          </div>
        </Link>
      </SectionCard>
